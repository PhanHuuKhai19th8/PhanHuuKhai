...
try {
    ...
    console.log('Đã Tải xong. Chạy lại script!');
    process.exit();
}
...
try {
    ...
    console.log('check in directory usersagents.txt and proxy.txt.');
    process.exit();
}
...
console.log('THÀNH CÔNG! RAW FLOOD VICTIM: '+VarsDefinetions.Objetive+' time:'+VarsDefinetions.time);
